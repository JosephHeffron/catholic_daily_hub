  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      <section className="card p-4" aria-labelledby="liturgical">
        ...
        <p className="text-sm text-neutral-400">{toISODate(date)} • Color: {liturgical.color}</p>
      ...
      <section className="card p-4" aria-labelledby="rosary">
        <h2 id="rosary" className="text-xl font-semibold">Rosary Mystery Today — {rosary.set}</h2>
